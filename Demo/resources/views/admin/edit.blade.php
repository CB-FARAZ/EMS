...
<div id="main-content" class="h-full w-full bg-gray-50 relative  lg:ml-64">
    <main class="mr-6 mt-12 px-24 ml-10 bg-gray-100">

        <a href="{{route('employee')}}">
            <button class=" bg-gray-600 hover:bg-gray-500 rounded-lg px-8 py-2 text-gray-100 hover:shadow-xl mt-2 mr-2">Back</button>
        </a>
                ...
                <div class="w-5/6 md:w-3/4 lg:w-2/3 xl:w-[500px] 2xl:w-[550px] mt-8 mx-auto px-16 py-8 rounded-lg">
                    ...
                    <form class="my-8 text-sm" action="{{ route('edit.process', ['id' => $user->id]) }}" method="post">
                        ...
                        <div class="my-4 flex items-center justify-end space-x-4">
                            ...
                            <button class="bg-blue-600 hover:bg-blue-700 rounded-lg px-8 py-2 text-gray-100 hover:shadow-xl transition duration-150 ">Update</button>
                        </div>
