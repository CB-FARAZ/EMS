                ...
                <div class="w-5/6 md:w-3/4 lg:w-2/3 xl:w-[500px] 2xl:w-[550px] mt-8 mx-auto px-16 py-8 rounded-lg">
                    ...
                    <form class="my-8 text-sm" action="{{ route('edit.process', ['id' => $user->id]) }}" method="POST">
                        ...
                        <div class="my-4 flex items-center justify-end space-x-4">
                            <button
                                class="bg-gray-500 hover:bg-slate-400 rounded-lg px-8 py-2 text-gray-100 hover:shadow-xl transition duration-150 uppercase">
                                <a href="{{route('employee')}}">Back</a></button>
                            <button
