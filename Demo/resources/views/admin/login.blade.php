...
<div class="bg-teal-50 w-full shadow-4xl rounded-lg h-screen ">
    ...
    <div class=" flex min-h-full flex-col justify-center px-2 py-4 lg:px-8 shadow-2xl">
        ...
        <h2 class="text-center text-3xl text-gray-800 mt-8 animate-bounce">

            Welcome to HR System
        </h2>

        <p class="text-center text-sm">Login in. To see it in action.</p>
            ...
            <form
                ...
                <div>
                    ...
                    <div>
                        <button type="submit"
                                id="BtnSave"
                                class="text-center  animate-pulse hover:bg-teal-200 bg-teal-300 font-medium p-2 md:p-4 text-black w-full">
                            Login
                        </button>
