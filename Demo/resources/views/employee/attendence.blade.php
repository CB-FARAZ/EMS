...
{{--            </h3>--}}
          ...
          <p>
            ...
            <div class="my-4 flex items-center justify-center space-x-4">
                ...
                >
                    @csrf
                        <button class="flex bg-orange-600 hover:bg-orange-300 text-white rounded-lg px-4 py-2  hover:shadow-xl transition duration-150">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-2"> <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /> </svg>
                        Time-In
                    </button>
            ...
            <div class="my-4 flex items-center justify-center space-x-4">
                ...
                >
                    @csrf
                    <button class="flex bg-orange-600 hover:bg-orange-300 text-white rounded-lg px-2 py-2  hover:shadow-xl transition duration-150">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mx-2"> <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /> </svg>
                        Time-Out
                    </button>
...
<script>
    ...
    var target_date = new Date('May, 9, 2014').getTime();
